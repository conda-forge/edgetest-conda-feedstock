...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/edgetest-conda-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14793&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/edgetest-conda-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `edgetest-conda` can be installed with:

```
conda install edgetest-conda
```

It is possible to list all of the versions of `edgetest-conda` available on your platform with:
